...
import {elementsState, selectedElementState, Element} from './components/Rectangle/Rectangle'
...
const selectedElementProperties = selector<Element | undefined>({
    ...
    get: ({get}) => {
        ...
        return get(elementsState(selectedElementId))
    },
    ...
    set: ({get, set}, newElement) => {
        ...
        set(elementsState(selectedElementId), newElement)
    },
})
